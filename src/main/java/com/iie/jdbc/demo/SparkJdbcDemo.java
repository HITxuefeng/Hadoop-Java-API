...
public class SparkJdbcDemo {

	public static void main(String args[]) {
		//String sql = args[0];//业务sql操作语句
//		String sql = "select * from healthmonitor.tb_checklist where selfcheckdate>'2017-10-21 00:00:00'";
...
//            System.out.println("打印输出结果：");
			...
			String sql1 = "insert into tb_checklist(selfcheckid,envircode,selfcheckdate,name,birthday,gender,idcardtype,idcardno,iccardtype,iccardno,govcode,doctorcode,doctorname,deviceid) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
//				System.out.println(rs.getString(0));
				...
				prest.setString(12, rs.getString(12));
